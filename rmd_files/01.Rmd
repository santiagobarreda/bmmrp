...
```{r F1-1, echo = FALSE, fig.height = 3, fig.width = 8, echo = FALSE, fig.cap = "(left) Average height of males and females in the United states of America. (middle) Average f0 produced by male and female speakers from 5 years of age to adulthood. (right) Estimated vocal-tract length for male and female speakers from 5 years of age to adulthood, based on the acoustic data provided in Lee at al. (?)."}
