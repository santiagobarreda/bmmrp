...
a priori, apparent category, apparent height, auditory sensation, behavioral measures, Boolean, box plot, Categorical, contingency table, continuous, controlled experiments, cross tabulation, data frame, dependent variables, discrete, effect, exchangeable, experiment, factors, fundamental frequency, Hertz, histogram, independent variables, indexical characteristics, inductive, Inference, interquartile range, levels, logical, long format, median, nominal variables, ordinal, outliers, perceptual experiment, pitch, population, quantiles, quartiles, random, random variable, rank, Resonance, sample, Scatter plots, science, scientific, scientific method, stimulus, the induction, Variables, vector, vocal tracts, whiskers
...
[@@ Larry Laudan has a great chapter in his book Science & Hypothesis where he makes a distinction between what he calls plebeian induction (e.g., the cats on the island) and aristocratic induction (e.g., using inductive reasoning about unobservable theoretical constructs). It might be useful to talk about "devising a test of the (inductive) hypothesis that all cats on the island are white" - i.e., asking questions and using procedures that will help ensure that the hypothesis is, in fact, reliable.] 
...
In addition to general age-related changes, the vocal folds tend to increase in size quite a bit during puberty for most males so that post-pubescent males tend to produce speech with a lower pitch than the rest of the human population. As a result of these relations, a voice with a lower voice pitch is more likely to be produced by someone who is *older*, *taller*, and *more male* than a voice with a higher pitch. The relationships between age, height, gender and f0 are presented in Figure \@ref(fig:F1-1) 
...
Running the command above will write out the entire vector to your screen, all 2780 observations of height responses that make up our data. Using the `head` function will show you the first six elements of an object, and you can get specific elements of the vector using brackets as shown below. 
