...
Abstract:
In this chapter, the use of experiments for scientific inference is discussed, in addition to some inherent problems associated with inferences based on limited amounts of observations. After this, the perceptual experiment that will be analyzed in this book is described, including a discussion of its structure, aims, procedures, and resulting data. Following the introduction of the experiment, the chapter discusses variables, and the way these are used in experiments to make inferences. R data types are then introduced, and the relationship between these and different kinds of variables is presented. Finally, there is a discussion of some ways to visualize different sorts of variables and the relationships between them.
