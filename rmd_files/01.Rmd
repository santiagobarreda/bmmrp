...
In this chapter, the use of experiments for scientific inference is discussed, in addition to some inherent limitations associated with inference based on limited amounts of observations. After this, the perceptual experiment that will be analyzed in this book is introduced, including a discussion of its structure, aims, procedures, and resulting data. Following the introduction of the experiment, variables, and the way that we use these in our experiment, are discussed. R data types are then introduced, and the relationship between these and different kinds of variables is presented. Finally, we present some ways to visualize our data depending on the sorts of variables being considered. 
