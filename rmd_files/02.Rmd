...
[@@ NHS: *Probability Theory: The Logic of Science* by Jaynes is a good one for Bayesian probability. *Modern Probability Theory and Its Applications* by Parzen is a good classical book. *A first course in Probability* by Ross is a good intro (undergraduate) textbook. So maybe cite these in the opposite order I wrote them here? That is, Ross as a good intro, Parzen as more advanced, and Jaynes as a distinctly Bayesian approach.]
...
[@@ Noah - check] [@@ NHS: I read down to the next (sub-)header, and made a couple minor changes - looks good]
