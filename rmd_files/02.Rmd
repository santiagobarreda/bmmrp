...
```{r F2-2, collapse = TRUE, fig.height = 2.5, fig.width=8, fig.cap='(left) Boxplot showing the duration of adult male speakers in our experiment. (right) Individual boxplots for the stimuli presented to each listener.', echo = FALSE}
...
```{r F2-3, fig.height = 2.5, fig.width = 8, fig.cap='(left) A histogram of adult male height judgments showing counts in each bin. (middle) The same data from the left panel, this time showing the density of the distribution. (right) The same data from the middle plot, this time with heights expressed in meters.', echo = FALSE}
...
```{r F2-5, fig.height = 3.5, fig.width = 8, fig.cap='The histogram shows the empirical distribution of height judgments for adult male speakers. The shaded area shows the theoretical density of the equivalent normal distribution. The red area corresponds to the theoretical probability of observing a height under 162 cm, based on the shape of the normal density.', echo = FALSE}
...
```{r F2-7, echo = FALSE, fig.height = 3, fig.width = 8, fig.cap='(left) The red curve indicates the probability of the points given an assumed mean of 170 cm. Vertical lines highlight the density over each point, given the assumed mean. (right) The same information as in the left plot, but given a mean of 160 cm.', echo = FALSE}
