...
mtext (side=2,outer=FALSE,text=expression(paste("P(", mu,") = \mathrm{N}(180,100)")),line=1,cex=0.9)
...
mtext (side=2,outer=FALSE,text=expression(paste("P(", mu,") = \mathrm{N}(180,15)")),line=1,cex=0.9)
...
mtext (side=2,outer=FALSE,text=expression(paste("P(", mu,") = \mathrm{N}(180,1)")),line=1,cex=0.9)
