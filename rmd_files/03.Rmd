...
```{r F3-2, fig.width = 8, fig.height = 2.5, fig.cap = "(left) Individual samples from the posterior distribution of the model intercept parameter. (right) A histogram of the samples on the left. The curve shows the density of a normal distribution with a mean of 173.8 and a standard deviation of 0.30.", echo = FALSE}
...
[@@ NHS: Is that something I put there? Is there a section I need to look at? I'm confused.]
