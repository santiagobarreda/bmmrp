...
```{r F44, fig.height = 3, fig.width = 8, fig.cap="--", echo=FALSE}
...
boxplot (height_centered ~ L, data=men, col = 0, ylim = c(-30,20))
abline (h=0)
...
```
```{r, include = FALSE}
# saveRDS (multilevel_L_S, '../models/4_multilevel_L_S.RDS')
