...
1) Easy: Analyze the (pre-fit) model that's exactly like the one in this chapter, except using the data in `exp_ex` (`bmmb::get_model("model_multilevel_L_S_ex.RDS")`).
