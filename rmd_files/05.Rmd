...
multilevel_model = bmmb::get_model ('5_model.RDS')
```
```{r, include = FALSE}
...
Here we compare the output of `brms` to the output of the `lmer` ("linear mixed-effects regression") function, a very popular function for fitting multilevel models in the lme4 R package. Below we fit a model that is analogous to our `model_sum_coding` model.
