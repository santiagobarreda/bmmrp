...
[@@ SB - be clear Im using absolute values different from parameter]
...
[@@ SB - hat came out of nowhere, check where I define it]
...
```{r F5-6, fig.height = 3, fig.width=8, fig.cap = "(left) Estimated listener means and 95% credible intervals. Crosses indicate no pooling estimes. (right) Estimated listener effects and 95% credible intervals. Crosses indicate centered no pooling estimes.", echo = FALSE}
...
[@@ SB - its possible this makes no sense]
