...
[@@ Noah check subsection] [@@ NHS looks good]
...
[@@ Noah check subsection] [@@ NHS looks good, made some minor changes]
...
```{r F5-3, fig.height = 3, fig.width=8, fig.cap = "(left) Distribution of apparent heights according to apparent age group, across all listeners. (right) Same as left panel but presented individually for each listener. In each case, the first box of each color (the higher box) represents responses for apparent adults.", echo = FALSE}
