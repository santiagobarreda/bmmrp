...
```{r F6-9, fig.width = 8, fig.height =2.5, fig.cap="(left) Listener-dependent mean effects and credible intervals estimated using brms models. Crosses indicate random effects estimated by lmer. (right) Same as the left panel but showing the listener-dependent age effects.", echo=FALSE,cache=FALSE}
...
brmplot (random_effects[,,1], col = bmmb::cols,
         ylab = "Apparent height (cm)", xlab="Listener")
