...
The variance of a variable is the expected value of squared deviations from the mean. The **covariance** of two variables is the expected value of the product of their deviations of each from their respective means. The covariance of two variables can be estimating by calculating the sum of the product of deviations from the mean and dividing by the number of observations minus one, as seen in \@ref(eq:6-2a).
...
listener_age_effects = listener_age_means[1,] - listener_age_means[2,]
...
axis (side=1,at=1:3,labels = c("x1","x1, x2","x1, x2, x3"),cex=1.1)
