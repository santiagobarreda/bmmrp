...
In contrast, the out of sample prediction gets steadily worse as more predictors are added. In other words, including 'extra' predictors in your model will help explain any data better, however, the additional predictors may not necessarily result in better out of sample prediction, and may actually make things worse.  


```{r F66, fig.height = 4, fig.width = 7, fig.cap="--", cache = TRUE, echo = FALSE}
################################################################################
### Figure 6.6
################################################################################
...
In the example above we knew the true underlying model and generated out of sample data that exactly conformed to the characteristics of our sample. In real life, researchers do not usually have access to real out of sample data, nor do they they the characteristics of the 'true' model that underlies the data. As a result, 



In real life, we 

we dont know what the difference between they two, but we do know that they tend to diverge at a certain rate. fixed slopes, uncertain intercept difference. Clever people have taken advantage of this from time.
