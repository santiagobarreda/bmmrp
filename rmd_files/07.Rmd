...
```{r F72b, fig.height = 3, fig.width=8, fig.cap = "(left) Means and 95% credible intervals for group effects for our four group model. H1 through H4 reflect the effects for boys, girls, men, and women respectively.  (right) bla.", echo = FALSE}
...
```{r F73, echo = FALSE, out.width = "100%", fig.cap = "Data from four groups of subjects (S) divided according to a two grouping factors A and B."}
...
```{r F77, fig.height=3,fig.width=8,fig.cap="Interaction plots showing comparing our f0 data to different posterior predictions, with and without RE (random effects).", echo = FALSE}
...
```{r F79, fig.height=5,fig.width=8,fig.cap="--.", echo = FALSE}
...
```{r  F710, fig.height=3,fig.width=8,fig.cap=".", echo = FALSE}
