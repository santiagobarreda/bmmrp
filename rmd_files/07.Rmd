...
And we are goiong to ask the following basic question:

Q1) Are there differences in average apparent height based on appearent speaker category?
...
Q1) Are there differences in average apparent height based on apparent speaker age?

Q2) Are there differences in average apparent height based on apparent speaker gender?
...
And we are going to add one more research question:

Q1) Are there differences in average apparent height based on apparent speaker age?

Q2) Are there differences in average apparent height based on apparent speaker gender?

Q3) Is there an interaction between apparent gender and age on apparent height? If so, what is it's effect?
...
We are primarily interested in discussing interactions, but we want to spend a moment looking at the listener random effects in our model, since there are now several. We can see the short model summary below:
