...
[@@ NHS: need subscripts for the $\Sigma$ terms in the mvnormal parts of the model? these are distinct matrices, after all... Also, should the R terms for these be in the model?]
