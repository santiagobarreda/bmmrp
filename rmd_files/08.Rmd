...
prior_informative =  
  brms::brm (height ~ A + G + A:G + (A + G + A:G|L) + (1|S), 
             data = exp_data, chains = 1, cores = 1, 
             warmup = 1000, iter = 5000, thin = 1, prior = priors)
```
