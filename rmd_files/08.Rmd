...
```{r F83, fig.height = 4, fig.width = 8, fig.cap="--", cache = FALSE, echo = FALSE}
################################################################################
### Figure 8.3
################################################################################
...
```{r F84, fig.height = 3, fig.width = 8, fig.cap="--", cache = FALSE, echo = FALSE}
...
```{r F85, fig.height = 3, fig.width = 8, fig.cap="--", cache = FALSE, echo = FALSE}
...
```{r F86, fig.height = 3.5, fig.width = 8, fig.cap="--", cache = FALSE, echo = FALSE}
...
```{r, include = TRUE, eval = FALSE}
# Or download it from the GitHub page:
model_het_group = bmmb::get_model ('8_model_het_group.RDS')
```
```{r, include = FALSE}
#  saveRDS (model_het_group,"8_model_het_group.RDS")
...
```{r F87, fig.height = 3, fig.width = 8, fig.cap="--", cache = FALSE, echo = FALSE}
...
brmplot (bmmb::getsds(model_het_group)[7:10,], col = cols[2:5])
abline (h=2.36)
