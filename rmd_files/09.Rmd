...
\begin{equation}
\begin{aligned}
\mathrm{height}_{[i]} \sim \mathrm{t}(\mu_{[i]},\sigma, \nu) \\ 
\mu_{[i]} = a +  b \times \mathrm{vtl}_{[i]} \\
...
- causal but still observational
- causality is a scientific claim not statistical
