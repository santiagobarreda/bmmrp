...
plot (height ~ vtl_original, data = aggd, pch=16,col=yellow, cex=1, ylim = c(135,185),
      yaxt='n',xlab="") 
abline (lm(height ~ vtl_original,data=aggd)$coefficients,col=deepgreen,lwd=3); 
...
```{r F9-6, fig.width = 8, fig.height = 5, fig.cap="Each plot shows responses from a single subject. The line with matched color represents the listener-specific line. The broken black line in each plot is the average 'main effects', average line.", echo = FALSE, cache=FALSE}
...
```{r F9-8, fig.width = 8, fig.height = 5, fig.cap="Each plot shows responses from a single subject.", echo = FALSE, cache=FALSE}
