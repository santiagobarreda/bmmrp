...
These boundaries are presented with our data in figure \@ref(fig:F10-5). The right plot divides the VTL dimension between sections associated with female classifications and sections associated with male classifications, overall, and based on apparent age. We can see in each case that the category boundary falls at the $y$ intercept corresponding to each line in the left plot of the same figure. 
