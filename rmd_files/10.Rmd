...
- explain that reference, 0 variable, is set to horizontal line at zero effectively
- this is like setting its outcome to zero. this is exponentiated to eual 1. 
- so, this is like setting its odds to 1 always. so if something is three times as likely its 3/1. It could have been 6/3 or 9.3/3.1 or an infinity more. but 1 and 0 are convenient numbers. 
- this will come up in chapter 12 when we discuss multinomial regression.
...
$$
\begin{equation}
\mathrm{logit}^{-1}(z) = \frac{e^{z}}{1 + e^{z}}
(\#eq:106)
\end{equation}
$$
