...
The comparison suggests that the model that includes the interaction does a better job of explaining our data, but the differences between the two models is not terribly large (about two standard errors).
