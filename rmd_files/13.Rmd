...
The repetitive vibration of the vocal folds results in a repetitive speech sound. Repetitive sounds can feel 'musical' or 'harmonic' to humans; these are terms that are difficult to define but that most people intuitively understand. A bell [@@ NHS: actually, bells have really weird acoustics - they typically have lots of non-harmonic components, see, e.g., https://www.jstor.org/stable/27852858, but I suppose this is irrelevant to the point here - bells are more harmonic than waterfalls and fans...] or flute is harmonic, a waterfall or the noise a fan makes is not. The repetition rate of sounds is referred to as the fundamental frequency (f0) of the sound. The f0 of a sound is the strongest determinant of perceived pitch. We say strongest because perceived pitch can also be (weakly) affected by the loudness of a sound, among other things, however it is still primarily dependent on f0. [@@ NHS: pitch is also affected by spectral shape, at least to some extent]
...
[@@ NHS: left off reading/reviewing here 2022.09.10 2:59 PM ET]
...
```{r F13-12, fig.width = 8, fig.height = 2, fig.cap = "Speaker random effects. Point colors indicate veridical speaker category for boys, girls, men and women.", echo = FALSE, cache = FALSE}
