...
```{r F13-11, fig.width = 8, fig.height = 2, fig.cap = ".", echo = FALSE, cache = TRUE}
tab = table (exp_data$S, exp_data$C_v)
mod_cat = apply (tab, 1,which.max)
