...
```{r F13-6, echo = FALSE, fig.height = 2.75, fig.width = 8, echo = FALSE, fig.cap = "(left) Posterior means and 95% credible intervals for  (middle) . (right) ."}
