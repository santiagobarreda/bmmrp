...
plot (aggdmu$age[aggdmu$sex=="f"]-.1,aggdmu$F0[aggdmu$sex=="f"],
      pch=16,col=2,lwd=2,cex=1.5, ylim = c(90,320),type='b', xlab="Age (years)",
      ylab = "f0 (Hz)",xlim=c(2,21),cex.axis=1.3,cex.lab=1.3)
lines (aggdmu$age[aggdmu$sex=="m"]+.1,aggdmu$F0[aggdmu$sex=="m"],
      pch=16,col=4,lwd=2,cex=1.5,type='b')
grid()

aggdmu

phonTools::errorbar(aggdmu$age[aggdmu$sex=="f"]-.1,aggdmu$F0[aggdmu$sex=="f"],
                    aggdsd$F0[aggdsd$sex=="f"],col=2,lwd=1,length=0.051)
phonTools::errorbar(aggdmu$age[aggdmu$sex=="m"]+.1,aggdmu$F0[aggdmu$sex=="m"],
                    aggdsd$F0[aggdsd$sex=="m"],col=4,lwd=1,length=0.051)
...
plot (height_data$height[height_data$gender=="f"][-c(1,2,3,18,19,20)],
      aggdmu$F0[aggdmu$sex=="f"], pch=16,col=2,lwd=2,cex=1.5, ylim = c(100,300),
      type='b', xlab="Hieght (cm)", ylab = "f0 (Hz)",xlim=c(110,180),cex.axis=1.3,
      cex.lab=1.3)
lines (height_data$height[height_data$gender=="m"][-c(1,2,3,18,19,20)],
       aggdmu$F0[aggdmu$sex=="m"],
      pch=16,col=4,lwd=2,cex=1.5,type='b')
grid()
...
plot (aggdmu$age[aggdmu$sex=="f"]-.1,aggdmu$vtl[aggdmu$sex=="f"],
      pch=16,col=2,lwd=2,cex=1.5, ylim = c(10,16),type='b', xlab="Age (years)",
      ylab = "VTL (cm)",xlim=c(2,21),cex.axis=1.3,cex.lab=1.3)
lines (aggdmu$age[aggdmu$sex=="m"]+.1,aggdmu$vtl[aggdmu$sex=="m"],
      pch=16,col=4,lwd=2,cex=1.5,type='b')
grid()

phonTools::errorbar(aggdmu$age[aggdmu$sex=="f"]-.1,aggdmu$vtl[aggdmu$sex=="f"],
                    aggdsd$vtl[aggdsd$sex=="f"],col=2,lwd=1,length=0.051)
phonTools::errorbar(aggdmu$age[aggdmu$sex=="m"]+.1,
                    aggdmu$vtl[aggdmu$sex=="m"],
                    aggdsd$vtl[aggdsd$sex=="m"],col=4,lwd=1,length=0.051)
