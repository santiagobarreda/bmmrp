...
As we've noted repeatedly in this book, finding a statistical association between variables is not the same thing as showing that there is a causal relationship between variables. 

You might think, doesn't this just mean that I will find whatever I want to find, or expect to find? Think of it this way. The scientific knowledge accumulated in all domains over the last several hundred years is like a puzzle that is mostly filled in, but has a lot of missing parts. Your experiment is like one piece of this puzzle, and you are looking for a place to put it in the puzzle. In most cases, the piece will fit in the puzzle, meaning that it 'makes sense' given what we already know. 
